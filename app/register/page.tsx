    ...
    <div className="min-h-screen bg-[#FAFAF7] flex">
      ...
      <div className="hidden lg:flex flex-col justify-start w-[46%] bg-[#0D1B2A] px-14 py-12 relative overflow-hidden">
        ...
        <div className="relative ">
          ...
          <p className="text-white/40 text-sm leading-relaxed max-w-xs">
            Whether you&apos;re seeking legal help or offering your expertise — Lex.In is built for you.
          </p>
      ...
      <div className="flex-1 flex items-start justify-center pt-20 px-6 py-12 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <h1 className="font-serif text-3xl text-[#0D1B2A] mb-1">Create an account</h1>
          <p className="text-sm text-[#64748B] mb-6">Join thousands using Lex.In for their legal needs</p>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            {ROLES.map((r) => (
              ...
              >
                <span className={role === r.id ? "text-[#C9A84C]" : "text-[#64748B]"}>{r.icon}</span>
                <div>
                  <p className="text-sm font-semibold">{r.label}</p>
                  <p className={`text-xs mt-0.5 ${role === r.id ? "text-white/50" : "text-[#94A3B8]"}`}>{r.desc}</p>
                </div>
              </button>
            ))}
          </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wide text-[#0D1B2A] mb-1.5">First Name</label>
                <input
                  type="text"
                  name="firstName"
              ...
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wide text-[#0D1B2A] mb-1.5">Last Name</label>
                <input
                  type="text"
                  name="lastName"
                  value={form.lastName}
            ...
            <div>
              <label className="block text-xs font-semibold uppercase tracking-wide text-[#0D1B2A] mb-1.5">Email Address</label>
              <input
                type="email"
                name="email"
                value={form.email}
            ...
            <div>
              <label className="block text-xs font-semibold uppercase tracking-wide text-[#0D1B2A] mb-1.5">Phone Number</label>
              <div className="flex">
                <span className="flex items-center px-3.5 border border-r-0 border-[#E2E8F0] rounded-l-lg bg-[#F8FAFC] text-sm text-[#64748B]">+91</span>
                <input
                  type="tel"
                  name="phone"
                  value={form.phone}
            ...
            <div>
              <label className="block text-xs font-semibold uppercase tracking-wide text-[#0D1B2A] mb-1.5">Password</label>
              <div className="relative">
                <input
            ...
            {role === "LAWYER" && (
              <div className="space-y-4 border border-[#E2E8F0] rounded-xl p-4 bg-white">
                <p className="text-xs font-semibold uppercase tracking-wide text-[#C9A84C]">Lawyer Details</p>

                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wide text-[#0D1B2A] mb-1.5">Bar Council Enrollment No.</label>
                  <input
                    type="text"
                    name="barNumber"
                ...
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wide text-[#0D1B2A] mb-1.5">Primary Specialization</label>
                  <select
                    name="specialization"
                ...
                <div className="flex items-start gap-3 bg-[#FAFAF7] rounded-lg p-3">
                  <svg className="w-4 h-4 text-[#C9A84C] shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
                  </svg>
                  <p className="text-xs text-[#64748B] leading-relaxed">
                    You&apos;ll be asked to upload your Bar Council certificate and ID proof after registration. Your profile goes live after admin verification.
                  </p>
                </div>
              </div>
            )}
            ...
            <button
              type="button"
              className="w-full h-11 bg-[#0D1B2A] hover:bg-[#1A3050] text-white text-sm font-medium rounded-lg transition-colors"
            >
              Create Account
            </button>
          </div>
